...
lib.ssMetadata = [
		{name:"SHAGEROTA_atlas_", frames: [[3836,580,185,48],[3991,422,48,56],[3836,524,251,54],[2604,1893,271,191],[3836,211,209,209],[3836,422,153,100],[2877,1898,281,156],[3620,1868,323,165],[2002,899,960,590],[2002,0,1832,897],[2964,899,960,590],[3006,1491,327,405],[3620,1491,283,375],[3836,0,209,209],[3335,1491,283,375],[3335,1868,283,375],[2604,1491,400,400],[2002,1491,600,600],[0,0,2000,2000]]}
];
...
// stage content:
(lib.SHAGEROTA = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		function myInterval() {
			...
			if (newTimer.text == "0") {
				...
				//משתנה שמכיל את מספר השגיאות פר פריט
		...
		function fly() {
			...
			//משתנה שמכיל את מספר השגיאות פר פריט
			WrongT = arrayQues[mychoice - 1][qnum][0][2];
		...
		function finalAnimationSpace() {
			...
			timeEndAnimatiom = setInterval(finalFeedback, 12000);
		}
		...
		function finalFeedback() {
			...
			//ניקוי האינטרוול
			clearInterval(timeEndAnimatiom);
